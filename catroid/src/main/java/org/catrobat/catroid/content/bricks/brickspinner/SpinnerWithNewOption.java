...
public class SpinnerWithNewOption<T extends Nameable> implements AdapterView.OnItemSelectedListener,
	...
	public SpinnerWithNewOption(@IdRes int spinnerId, View parent, List<T> items,
	...
	public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
		if (position != 0) {
			spinnerSelectionListener.onItemSelected(get(spinnerAdapter.getItem(position)));
		}
	}
	...
	@Nullable
	private T get(@Nullable String name) {
		if (name == null) {
			return null;
		}
