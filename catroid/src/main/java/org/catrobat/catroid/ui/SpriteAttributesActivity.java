...
public class SpriteAttributesActivity extends BaseActivity implements
	...
	private static final String TAG = SpriteAttributesActivity.class.getSimpleName();
	...
	public void onActivityResult(int requestCode, int resultCode, Intent data) {
		if (requestCode == PreStageActivity.REQUEST_RESOURCES_INIT && resultCode == RESULT_OK) {
			...
			if (DroneServiceWrapper.checkARDroneAvailability()) {
				intent = new Intent(SpriteAttributesActivity.this, DroneStageActivity.class);
			} else {
				intent = new Intent(SpriteAttributesActivity.this, StageActivity.class);
			}
	...
	public void handleNfcTagsButton(View view) {
		startScriptActivity(ScriptActivity.FRAGMENT_NFC_TAGS);
	}
