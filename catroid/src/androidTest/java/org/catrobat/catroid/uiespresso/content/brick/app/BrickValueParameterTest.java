...
public class BrickValueParameterTest {
	...
	public void testSoundBricksDefaultValues() {
		...
		checkIfBrickAtPositionShowsSpinnerWithText(PlaySoundBrick.class, 0, R.id.playsound_spinner, R.string
		...
		checkIfBrickShowsSpinnerWithText(PlaySoundAndWaitBrick.class, R.id.playsound_spinner, R.string
				.new_broadcast_message);
