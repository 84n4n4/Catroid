...
public class PointToBrick extends BrickBaseType implements
	...
	private transient Sprite previouslySelectedObject;
	...
	public View getView(final Context context, int brickId, BaseAdapter baseAdapter) {
		...
		spinner.setSelection(spinnerAdapter.getPosition(previouslySelectedObject != null
				? previouslySelectedObject.getName() : null));
		return view;
	}

	@Override
	public boolean onNewOptionInDropDownClicked(View v) {
		previouslySelectedObject = pointedObject;
		new NewSpriteDialogWrapper(this, ProjectManager.getInstance().getCurrentScene()) {
			...
			public void onWorkflowCanceled() {
				...
				pointedObject = previouslySelectedObject;
				spinner.setSelection(spinnerAdapter.getPosition(previouslySelectedObject != null
						? previouslySelectedObject.getName() : null));
			}
