...
//	private Matcher cameraIntentMatcher;
...
//		cameraIntentMatcher = allOf(hasAction("android.media.action.IMAGE_CAPTURE"));
...
//				.getUiAutomation().executeShellCommand("pm reset-permissions");
