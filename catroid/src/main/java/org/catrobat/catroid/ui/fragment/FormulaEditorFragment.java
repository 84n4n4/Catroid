...
import static org.catrobat.catroid.ui.StageResourceHolder.translateBrickResourcesToRuntimePermissions;
...
public class FormulaEditorFragment extends Fragment implements ViewTreeObserver.OnGlobalLayoutListener,
	...
	private void showComputeDialog() {
		...
		List<String> requiredRuntimePermissions = translateBrickResourcesToRuntimePermissions(resourcesSet);

		new RequiresPermissionTask(REQUEST_PERMISSIONS_COMPUTE_DIALOG, requiredRuntimePermissions, R.string.runtime_permission_all) {
			public void task() {
