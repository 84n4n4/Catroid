...
import org.catrobat.catroid.ui.recyclerview.fragment.util.ProjectCreatorTask;
import org.catrobat.catroid.ui.recyclerview.fragment.util.ProjectLoaderTask;
...
public class ProjectFragment extends RecyclerViewFragment<ProjectData> implements
	...
	protected Set<String> getScope() {
		...
		for (ProjectData item : adapter.items) {
