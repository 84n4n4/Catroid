...
public class GlideToBrick extends FormulaBrick {
	...
	public GlideToBrick() {
		this(BrickValues.X_POSITION, BrickValues.Y_POSITION, BrickValues.GLIDE_SECONDS);
	}

	public GlideToBrick(int xDestinationValue, int yDestinationValue, int durationInMilliSecondsValue) {
		this(new Formula(xDestinationValue), new Formula(yDestinationValue), new Formula(durationInMilliSecondsValue / 1000.0));
	}
