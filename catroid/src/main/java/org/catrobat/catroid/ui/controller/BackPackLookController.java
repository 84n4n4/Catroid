...
public final class BackPackLookController {
	...
	public static final String TAG = BackPackLookController.class.getSimpleName();

	private static final BackPackLookController INSTANCE = new BackPackLookController();

	private BackPackLookController() {
	}

	public static BackPackLookController getInstance() {
		return INSTANCE;
	}
