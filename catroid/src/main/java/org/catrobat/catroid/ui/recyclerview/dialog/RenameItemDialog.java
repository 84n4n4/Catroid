...
public class RenameItemDialog extends TextDialog {
	...
	public RenameItemDialog(int title, int inputLabel, String previousText, RenameItemInterface renameItemInterface) {
	...
	protected boolean handlePositiveButtonClick() {
		...
		if (renameItemInterface.isNameUnique(newName) || newName.equals(previousText)) {
